...
CREATE TABLE `trainroutes` (
  ...
  CONSTRAINT `trainroutes_ibfk_1` FOREIGN KEY (`TrainID`) REFERENCES `trains` (`TrainID`),
  CONSTRAINT `trainroutes_ibfk_2` FOREIGN KEY (`StationID`) REFERENCES `stations` (`StationID`)
...
LOCK TABLES `trainroutes` WRITE;
/*!40000 ALTER TABLE `trainroutes` DISABLE KEYS */;
/*!40000 ALTER TABLE `trainroutes` ENABLE KEYS */;
UNLOCK TABLES;
